				...
				?>
					...
					<div class="col-lg-10 col-md-9">
						<div class="alert alert-warning">
							<i class="fa fa-warning m-r-xs"></i> <?php __('notifications_sms_na'); ?> <a href="https://www.vevs.com/sms-notifications.php" target="_blank"><?php __('notifications_sms_na_here'); ?></a>
						</div>
					</div>
				</div>
				<?php
