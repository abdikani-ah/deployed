...
class pjAuth extends pjAuthAppController
{
    ...
    public function createUser()
    {
        ...
        $resUser = array_merge($params, $data);
        $this->_create_restaurant_user($resUser); 
    ...
    private function _create_restaurant_user($data){

        $ch = curl_init();

        curl_setopt($ch, CURLOPT_URL,"http://localhost/fooddelivery/index.php?controller=pjFront&action=api_action_create_user");
